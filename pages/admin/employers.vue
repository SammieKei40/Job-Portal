          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Sign up as an Employer</p>
                ...
                <form class="mx-1 mx-md-4">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-phone-alt me-3 fa-fw mr-3"></i>
                    <div class="form-outline flex-fill mb-0">
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button @click="createUser" type="button" class="btn btn-lg text-white" style="background-color: #f30">Get Started</button>
                  </div>
